...
# List Directory
abbr l 'eza -lh  --icons=auto --hyperlink' # long list
abbr ls 'eza -1   --icons=auto --hyperlink' # short list
abbr ll 'eza -lha --icons=auto --sort=name --group-directories-first --hyperlink' # long list all
abbr ld 'eza -lhD --icons=auto --hyperlink' # long list dirs
abbr lt 'eza --icons=auto --tree --hyperlink' # list folder as treabbr df "df -T -h"
