...
# Plugins
plugins=(archlinux docker fzf git git-lfs nmap python qrcode thefuck systemadmin systemd taskwarrior toolbox uv vscode sudo zsh-autosuggestions zsh-syntax-highlighting)
